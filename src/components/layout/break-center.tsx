                            ...
                            {row.map((cell, cellIndex) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        initial={false}
                                        animate={{ rotateX: isSubmitted ? 360 : 0 }}
