...
function ExplanationSheet({ open, onOpenChange, title, description, icon: Icon }: { open: boolean; onOpenChange: (open: boolean) => void; title: string; description: string; icon?: React.ElementType; }) {
    return (
