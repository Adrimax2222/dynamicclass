                                  ...
                                  <div className={cn("space-y-4", (registrationMode === 'join' && !isCenterValidated) || (registrationMode === 'create' && !isCenterNameValidated) ? "hidden" : "block")}>
                                      {registrationMode === 'join' && (
                                        <>
                                          ...
                                          <AlertDialog>
                                            <AlertDialogTrigger asChild>
                                              <Button variant="link" className="text-xs p-0 h-auto">Si tu clase no existe en tu centro, pulsa aquí.</Button>
                                            </AlertDialogTrigger>
                                            <AlertDialogContent>
                                              <AlertDialogHeader>
                                                <AlertDialogTitle>¿Tu Clase no está en la Lista?</AlertDialogTitle>
                                                <AlertDialogDescription>
                                                  No te preocupes. Continúa tu registro seleccionando la opción <strong className="text-foreground">"Uso Personal"</strong>.
                                                  <br/><br/>
                                                  Una vez dentro de la aplicación, ve a <strong className="text-foreground">Perfil &gt; Configuración de Cuenta &gt; Unirse a un centro</strong>, valida el código de tu centro y podrás crear tu clase desde allí.
                                                </AlertDialogDescription>
                                              </AlertDialogHeader>
                                              <AlertDialogFooter>
