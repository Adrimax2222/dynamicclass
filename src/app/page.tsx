                        ...
                        <div key={step.id} className={cn("w-full absolute top-0", getAnimationClass(index))}>
                          ...
                          {index === 1 && (
                            <div className="space-y-4">
                                <FormField control={form.control} name="center" render={({ field }) => (<FormItem><FormLabel>Código de Centro Educativo</FormLabel><FormControl><Input placeholder="Escribe el código de tu centro" {...field} /></FormControl><FormDescription>Introduce el código proporcionado por tu centro para unirte a su grupo.</FormDescription><FormMessage /></FormItem>)} />
