...
export default function RecursosPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center bg-muted/20 p-4">
        ...
        <Card className="shadow-2xl">
            ...
            <div className="border border-amber-500/30 bg-amber-500/10 p-4 rounded-lg text-amber-800 dark:text-amber-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs">
                    Dynamic Class <strong>no es un portal oficial</strong> de la Generalitat de Catalunya. Todo el contenido aquí mostrado es de carácter público y se ofrece a través de esta app para facilitar su acceso a la juventud.
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardContent>
             <Button
              ...
              onClick={() => router.push('/recursos/visor')}
            >
