...
import { Rocket, TrendingUp, Palette, FlaskConical, Brain, Zap, Wand2, Users, Globe, ShieldCheck, Gamepad2, BrainCircuit, Code, Heart, Scale } from "lucide-react";
...
const courseSections = [
    ...
    },
    {
        ...
        courses: [
            ...
            { title: "Google Hacking", description: "Aprende a buscar en Google como un pro (comandos para encontrar archivos ocultos, PDFs, etc.)." },
    ...
    },
    {
        ...
        courses: [
            ...
            { title: "Economía de Bolsillo: Impuestos, IVA y tu primer sueldo", description: "Explica de forma simple qué es el IVA, por qué el gobierno quita una parte del sueldo (IRPF) y cómo funciona un banco." },
    ...
    },
     {
        ...
        courses: [
            ...
            { title: "Cuerpo y Relaciones: Lo que no sale en las películas (ni en el porno)", description: "La realidad de los cuerpos, el consentimiento real, cómo poner límites y salud sexual básica." },
            { title: "Amor Propio vs. El Espejo de Instagram", description: "Cómo los filtros afectan nuestra percepción y cómo construir una relación sana con tu propia imagen." },
            { title: "Socializar en la Era del Algoritmo: El Arte de Conectar", description: "Cómo iniciar una conversación, leer el lenguaje corporal y la diferencia entre 'seguidores' y amigos reales." },
    ...
    },
    {
        ...
        courses: [
            ...
            { title: "Aviation Masterclass: De Pasajero a Capitán", description: "Principios de aerodinámica, cómo leer una cabina 'Glass Cockpit' y fases de un vuelo en simulador." },
